...
import jgicon from '../components/icon/index';
const Icon = wrap(jgicon);
...
describe('Icon', function() {
  ...
  it('should render to a <i class="xxx"></i>', () => {
    ...
    expect(iconNode.className).toContain('jgicon');
    expect(iconNode.className).toContain('jgicon-appstore');
  });
});
